...
- `Color` - Which color the dropshadow should have. Note that this also supports alpha channel for adjusting shadow transparency (#FFF0 = white with 0% transparency, #FFFF = white with 100% transparency).
