...
<!-- Note there are properties we are not touching here, as the following format is consithered best practice -->
...
You can specify the amount to resize the element by using:
